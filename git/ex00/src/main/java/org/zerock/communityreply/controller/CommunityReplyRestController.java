...
public class CommunityReplyRestController {
	...
	public ResponseEntity<Map<String, Object>> 
		list(PageObject pageObject, Long post_no) {
	...
	public ResponseEntity<String> write(@RequestBody CommunityReplyVO vo, HttpSession session) {
	...
	public ResponseEntity<String> update(@RequestBody CommunityReplyVO vo, HttpSession session) {
		log.info("update.do ---------------------------------");
	...
	// 어노테이션이 필요없습니다.
	public ResponseEntity<String> delete(CommunityReplyVO vo, HttpSession session) {
		log.info("delete.do --------------------------------------");
